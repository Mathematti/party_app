...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const MyHomePage(title: 'Party games'),
    );
  }
}
        ...
        actions: [
          IconButton(
              onPressed: () {
                showAboutDialog(
                    context: context,
                    children: [const Text('The best party games app ever')]);
              },
                ...
                ElevatedButton(
                    onPressed: () {
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => const HotPotato()));
                    },
                    child: const Text('Hot potato game')),
                ElevatedButton(
                    onPressed: () {
                      Navigator.push(
                          context,
